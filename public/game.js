...
function restartClicked() {
    ...
    y.style.backgroundColor = "#1E9600";
}
...
function vsPlayer(i) {
    ...
    if (moves % 2 === 1) {
        ...
        x.style.backgroundColor = "#1E9600";
...
function vsBotFirst() {
    ...
    x.innerHTML = '<img src="Images/' + comp + '.png" width="75%">';
    occupied[k - 1] = 1;
    moves += 1;
...
function playareaClicked(i) {
    ...
    if (level === 0) {
        zero_one = moves % 2;
        x.innerHTML = '<img src="Images/' + zero_one + '.png" width="75%">';
        vsPlayer(i);
    } else {
        x.innerHTML = '<img src="Images/' + human + '.png" width="75%">';
        player1.push(magicsquare[i - 1]);
        if (human === 1) {
            vsBotSecond();
        } else if (human === 0) {
...
function notHover() {
    ...
    if (level <= 0) {
        var x = document.getElementById("button1");
        x.style.backgroundColor = "#8E0E00";
    }
    else {
        var x = document.getElementById("button1");
        x.style.backgroundColor = "#52c234";
    }
}
...
function mediumClicked() {
    ...
    x.style.backgroundColor = "#8E0E00";
    y = document.getElementById("button1");
    y.style.backgroundColor = "#52c234";
    if (human === 0) {
        vsBotFirst();
    }
}
...
function initVsPlayer() {
    ...
    y.style.backgroundColor = "#8E0E00";
    y.innerHTML = "Vs Bot";
}
